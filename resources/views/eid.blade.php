                                                                ...
                                                                <div class="meditor">
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                <td colspan="1" rowspan="3" style="text-align: left; white-space: nowrap; width: 40%; background-color: rgb(255, 255, 255); vertical-align: top;">
                                                                                    <img alt="p" height="367" src="./img/laboratory/eid.jpg" style="float: left; " width="550" />
                                                                                </td>
                                                                                    ...
                                                                                    <p>
                                                                                        <span style="font-family:Arial,Helvetica,sans-serif;">
                                                                                            <span style="font-size:0.875em;">
                                                                                                <strong>Ergonomic and Innovation Design (EID) - C 1.07&nbsp;</strong>
                                                                                            </span><br />
                                                                                            <span style="font-size:0.75em;">
                                                                                                <strong>Bidang Fokus:</strong> Ergonomi fisik, ergonomi kognitif, ergonomi organisasional, keamanan dan kesehatan kerja, pengembangan produk.<br>
                                                                    ...
                                                                    <script>
                                                                        document.getElementById("sheetFrame").src =
                                                                            "https://docs.google.com/spreadsheets/d/e/2PACX-1vSn9HI3hlhrIEMu1QFJjhrNHCc4LH0PNFCGKJ_Uvf_55IciWI8-o8LPFdQsmvUh1EmfA3xpsC58yuVN/pubhtml?gid=81092520&amp;single=true&amp;widget=true&amp;headers=false" + new Date().getTime();
                                                                    </script>

                                                                ...
                                                                <div class="meditor">
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                <td colspan="1" rowspan="3" style="text-align: left; white-space: nowrap; width: 40%; background-color: rgb(255, 255, 255); vertical-align: top;">
                                                                                    <img alt="p" height="367" src="./img/laboratory/se.jpeg" style="float: left; " width="550" />
                                                                                </td>
                                                                                    ...
                                                                                    <p>
                                                                                        <span style="font-family:Arial,Helvetica,sans-serif;">
                                                                                            <span style="font-size:0.875em;">
                                                                                                <strong>Enterprise System (SE) - C 3.07&nbsp;</strong>
                                                                                            </span><br />
                                                                                            <span style="font-size:0.75em;">
                                                                                                <strong>Bidang Fokus:</strong> Sistem informasi manajemen, customer relationship management, enterprise resource planning, manajemen proyek teknologi informasi.<br>
                                                                    ...
                                                                    <script>
                                                                        document.getElementById("sheetFrame").src =
                                                                            "https://docs.google.com/spreadsheets/d/e/2PACX-1vQHMhxL48wcEVjHuUM6PFx6CyGyCU1CoKMYmu7xCRCBwf-1t4Y1BJSQwveu4EcNhU8oVKTBL_nDBsOk/pubhtml?gid=1101779927&amp;single=true&amp;widget=true&amp;headers=false" + new Date().getTime();
                                                                    </script>

                                                                ...
                                                                <div class="meditor">
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                <td colspan="1" rowspan="3" style="text-align: left; white-space: nowrap; width: 40%; background-color: rgb(255, 255, 255); vertical-align: top;">
                                                                                    <img alt="p" height="367" src="./img/laboratory/coming soon.png" style="float: left; " width="550" />
                                                                                </td>
                                                                                    ...
                                                                                    <p>
                                                                                        <span style="font-family:Arial,Helvetica,sans-serif;">
                                                                                            ...
                                                                                            <span style="font-size:0.75em;">
                                                                                                <strong> Bidang Fokus:</strong>Otomasi dan teknologi manufaktur, manajemen sistem produksi, manajemen kualitas, manufaktur keberlanjutan, design for X.<br>
                                                                    ...
                                                                    <script>
                                                                        document.getElementById("sheetFrame").src =
                                                                            "https://docs.google.com/spreadsheets/d/e/2PACX-1vTSiLuXEv7KY9RG_hZ7HiTWknIs4THGHh_O7NfMnHdBMj2mE5lpX0TA8xYlkiUcHpGWmYtaEmL_L4lH/pubhtml?gid=1092955703&amp;single=true&amp;widget=true&amp;headers=false" + new Date().getTime();
                                                                    </script>

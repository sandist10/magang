                                                                ...
                                                                <div class="meditor">
                                                                                    ...
                                                                                    <p>
                                                                                        <span style="font-family:Arial,Helvetica,sans-serif;">
                                                                                            <span style="font-size:0.875em;">
                                                                                                <strong>Logistic Supply Chain Enginering (LSCE) - &nbsp;</strong>
                                                                                            </span><br />
                                                                                            <span style="font-size:0.75em;">
                                                                                                <strong>Bidang Fokus:</strong> Manajemen rantai pasok, logistik dan distribusi, sistem pergudangan.<br>
                                                                    ...
                                                                    <script>
                                                                        document.getElementById("sheetFrame").src =
                                                                            "https://docs.google.com/spreadsheets/d/e/2PACX-1vS_Mj1tgbOftZE1s8Jeb3l51jrVjT--Q3oYBh7Li6Ecensw-8bLumcBssN-tUIiTL_ip-Qe50etPguG/pubhtml?gid=1641754635&amp;single=true&amp;widget=true&amp;headers=false" + new Date().getTime();
                                                                    </script>

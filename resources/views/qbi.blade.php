                                                                ...
                                                                <div class="meditor">
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                <td colspan="1" rowspan="3" style="text-align: left; white-space: nowrap; width: 40%; background-color: rgb(255, 255, 255); vertical-align: top;">
                                                                                    <img alt="p" height="367" src="./img/laboratory/qbi.jpg" style="float: left; " width="550" />
                                                                                </td>
                                                                                    ...
                                                                                    <p>
                                                                                        <span style="font-family:Arial,Helvetica,sans-serif;">
                                                                                            <span style="font-size:0.875em;">
                                                                                                <strong>Quantitative Modelling for Business and Industry (QBI) - C 5.06&nbsp;</strong>
                                                                                            </span><br />
                                                                                            <span style="font-size:0.75em;">
                                                                                                <strong> Bidang Fokus:</strong>Optimasi matematika, pemodelan dan simulasi, teori antrian dan pengelolaan proses, riset operasi, analisis regresi dan prediktif, data mining dan machine learning, analisis probabilistik.<br>
                                                                    ...
                                                                    <script>
                                                                        document.getElementById("sheetFrame").src =
                                                                            "https://docs.google.com/spreadsheets/d/e/2PACX-1vTEIofnSkmOzryfeqAgWzqa0Q38-OZUVK7Jt-LxFSoVr_9Q8MpoRow1MJ4cWUO4rZxMP_fTCjMMkB5_/pubhtml?widget=true&headers=false&cachebust=" + new Date().getTime();
                                                                    </script>
